...
<h2>Основы ООП</h2>
    ...
    <p>ООП - это парадигма программирования, в которой создаются "объекты" для работы. Эти объекты затем могут быть адаптированы к конкретным потребностям, чтобы обслуживать различные типы приложений, сохраняя при этом одинаковую кодовую базу.</p>
