...
<h2>Основы ООП</h2>
    ...
    <p>ООП - это парадигма программирования, в которой создаются "объекты" для работы. Эти объекты затем могут быть адаптированы к конкретным потребностям, чтобы обслуживать различные типы приложений, сохраняя при этом одинаковую кодовую базу. На самом деле полезно.</p>
    ...
    <ul>
        <li><div class="spoiler_v2">
                ...
                <div class="spoiler-block">
                    <p>Инкапсуляция — объединение полей и методов в классе, с целью закрыть прямой доступ к полям и открыть его для методов, которые этими полями управляют.</p>
...
<div class="spoiler_v2">
        <a href="#" class="spoiler-trigger"><span>Или же "по научному"</span></a>
        <div class="spoiler-block">
...
<h2>Паттерны</h2>
    ...
    <p>Паттерн (от англ. Pattern) — образец, шаблон.</p>
