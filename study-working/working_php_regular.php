...
<p class="like_b">C помощью регулярных выражений из нижеприведенного текста выбрать слова, которые содержат букву <big class="like_i">[і]</big> и все эти слова с этой буквой вывести отдельной строчкой</p>
...
//    echo "Строка: $line<br>";
    ...
    $match = [];
    if (preg_grep($regexp, $line, $match)) {
